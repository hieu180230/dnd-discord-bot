...
impl SPConvert for SPMonk {
    async fn from_value(&mut self, json: serde_json::Value) {
        ...
        self.martial_art.dice_count = json["martial_arts"].as_object().unwrap()["dice_count"]
            .as_i64()
            .unwrap() as i32;
        self.martial_art.dice_value = json["martial_arts"].as_object().unwrap()["dice_value"]
            .as_i64()
            .unwrap() as i32;
    }
    fn display(&self) -> String {
        format!(
            ...
            self.martial_art.dice_count,
            self.martial_art.dice_value
        )
    }
}
